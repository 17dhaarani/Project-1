...
# App title
st.set_page_config(page_title="Build Your Portfolio", layout="wide")
...
title = st.sidebar.text_input("Professional Title", "Software Engineer")
email = st.sidebar.text_input("Email", "john@example.com")
phone = st.sidebar.text_input("Phone", "+1 234 567 890")
bio = st.sidebar.text_area("Short Bio", "I am a passionate developer...")
